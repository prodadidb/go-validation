...
go-validation is a Go package that provides configurable and extensible data validation capabilities.
...
The go-validation package mainly includes a set of validation rules and two validation methods. You use 
...
```
go get github.com/go-ozzo/go-validation
```
...
import (
    ...
    "github.com/go-ozzo/go-validation"
    "github.com/go-ozzo/go-validation/is"
)
