...
func TestEnsureString(t *testing.T) {
	...
	for _, test := range tests {
		s, err := validation.EnsureString(test.value)
		if test.hasError {
...
func TestStringOrBytes(t *testing.T) {
	...
	for _, test := range tests {
		isString, str, isBytes, bs := validation.StringOrBytes(test.value)
...
func TestLengthOfValue(t *testing.T) {
	...
	for _, test := range tests {
		l, err := validation.LengthOfValue(test.value)
...
func TestToInt(t *testing.T) {
	...
	for _, test := range tests {
		l, err := validation.ToInt(test.value)
...
func TestToUint(t *testing.T) {
	...
	for _, test := range tests {
		l, err := validation.ToUint(test.value)
		assert.Equal(t, test.result, l, test.tag)
		assertError(t, test.err, err, test.tag)
	}
}
...
func TestToFloat(t *testing.T) {
	...
	for _, test := range tests {
		l, err := validation.ToFloat(test.value)
		assert.Equal(t, test.result, l, test.tag)
		assertError(t, test.err, err, test.tag)
	}
}
...
func TestIsEmpty(t *testing.T) {
	...
	for _, test := range tests {
		empty := validation.IsEmpty(test.value)
...
func TestIndirect(t *testing.T) {
	...
	for _, test := range tests {
		result, isNil := validation.Indirect(test.value)
