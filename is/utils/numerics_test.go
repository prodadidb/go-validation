...
func TestIsNegative(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsNegative(test.param)
		if actual != test.expected {
...
func TestIsNonNegative(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsNonNegative(test.param)
		if actual != test.expected {
...
func TestIsPositive(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsPositive(test.param)
		if actual != test.expected {
...
func TestIsNonPositive(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsNonPositive(test.param)
		if actual != test.expected {
...
func TestIsWhole(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsWhole(test.param)
		if actual != test.expected {
...
func TestIsNatural(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsNatural(test.param)
		if actual != test.expected {
...
func TestInRangeInt(t *testing.T) {
	...
	for _, test := range testAsInts {
		actual := utils.InRangeInt(test.param, test.left, test.right)
		if actual != test.expected {
...
func TestInRangeFloat32(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.InRangeFloat32(test.param, test.left, test.right)
		if actual != test.expected {
...
func TestInRangeFloat64(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.InRangeFloat64(test.param, test.left, test.right)
		if actual != test.expected {
...
func TestInRange(t *testing.T) {
	...
	for _, test := range testsInt {
		actual := utils.InRange(test.param, test.left, test.right)
		if actual != test.expected {
