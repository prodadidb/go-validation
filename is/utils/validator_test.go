...
func init() {
	utils.CustomTypeTagMap.Set("customFalseValidator", func(i interface{}, o interface{}) bool {
		return false
	})
	utils.CustomTypeTagMap.Set("customTrueValidator", func(i interface{}, o interface{}) bool {
		return true
	})
}
...
func TestIsAlpha(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsAlpha(test.param)
...
func TestIsUTFLetter(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsUTFLetter(test.param)
		if actual != test.expected {
...
func TestIsAlphanumeric(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsAlphanumeric(test.param)
		if actual != test.expected {
...
func TestIsUTFLetterNumeric(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsUTFLetterNumeric(test.param)
		if actual != test.expected {
...
func TestIsNumeric(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsNumeric(test.param)
		if actual != test.expected {
...
func TestIsUTFNumeric(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsUTFNumeric(test.param)
		if actual != test.expected {
...
func TestIsUTFDigit(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsUTFDigit(test.param)
		if actual != test.expected {
...
func TestIsLowerCase(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsLowerCase(test.param)
		if actual != test.expected {
...
func TestIsUpperCase(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsUpperCase(test.param)
		if actual != test.expected {
...
func TestHasLowerCase(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.HasLowerCase(test.param)
		if actual != test.expected {
...
func TestHasUpperCase(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.HasUpperCase(test.param)
		if actual != test.expected {
...
func TestIsHash(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsHash(test.param, test.algo)
		if actual != test.expected {
...
func TestIsExistingEmail(t *testing.T) {
	...
	var tests = []struct {
		...
		{"nosuchdomain@bar.coffee", true},
	}
	for key, test := range tests {
		actual := utils.IsExistingEmail(test.param)
		if actual != test.expected {
			t.Errorf("(key = %v) Expected IsExistingEmail(%q) to be %v, got %v", key, test.param, test.expected, actual)
		}
	}
}
...
func TestIsEmail(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsEmail(test.param)
		if actual != test.expected {
...
func TestIsRequestURL(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsRequestURL(test.param)
		if actual != test.expected {
...
func TestIsRequestURI(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsRequestURI(test.param)
		if actual != test.expected {
...
func TestIsFloat(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsFloat(test.param)
		if actual != test.expected {
...
func TestIsHexadecimal(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsHexadecimal(test.param)
		if actual != test.expected {
...
func TestIsHexcolor(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsHexcolor(test.param)
		if actual != test.expected {
...
func TestIsRGBcolor(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsRGBcolor(test.param)
		if actual != test.expected {
...
func TestIsNull(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsNull(test.param)
		if actual != test.expected {
...
func TestHasWhitespaceOnly(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.HasWhitespaceOnly(test.param)
		if actual != test.expected {
...
func TestHasWhitespace(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.HasWhitespace(test.param)
		if actual != test.expected {
...
func TestIsDivisibleBy(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsDivisibleBy(test.param1, test.param2)
		if actual != test.expected {
...
func ExampleIsDivisibleBy() {
	println("1024 is divisible by 64: ", utils.IsDivisibleBy("1024", "64"))
}
...
func TestIsByteLength(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsByteLength(test.param1, test.param2, test.param3)
		if actual != test.expected {
...
func TestIsJSON(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsJSON(test.param)
		if actual != test.expected {
...
func TestIsMultibyte(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsMultibyte(test.param)
		if actual != test.expected {
...
func TestIsASCII(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsASCII(test.param)
		if actual != test.expected {
...
func TestIsPrintableASCII(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsPrintableASCII(test.param)
		if actual != test.expected {
...
func TestIsFullWidth(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsFullWidth(test.param)
		if actual != test.expected {
...
func TestIsHalfWidth(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsHalfWidth(test.param)
		if actual != test.expected {
...
func TestIsVariableWidth(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsVariableWidth(test.param)
		if actual != test.expected {
...
func TestIsUUID(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsUUID(test.param)
		if actual != test.expected {
	...
	for _, test := range tests {
		actual := utils.IsUUIDv3(test.param)
		if actual != test.expected {
	...
	for _, test := range tests {
		actual := utils.IsUUIDv4(test.param)
		if actual != test.expected {
	...
	for _, test := range tests {
		actual := utils.IsUUIDv5(test.param)
		if actual != test.expected {
...
func TestIsCreditCard(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := utils.IsCreditCard(tt.number); got != tt.want {
...
func TestIsISBN(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsISBN(test.param, -1)
		if actual != test.expected {
	...
	for _, test := range tests {
		actual := utils.IsISBN10(test.param)
		if actual != test.expected {
	...
	for _, test := range tests {
		actual := utils.IsISBN13(test.param)
		if actual != test.expected {
...
func TestIsDataURI(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsDataURI(test.param)
		if actual != test.expected {
...
func TestIsMagnetURI(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsMagnetURI(test.param)
		if actual != test.expected {
...
func TestIsBase64(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsBase64(test.param)
		if actual != test.expected {
...
func TestIsISO3166Alpha2(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsISO3166Alpha2(test.param)
		if actual != test.expected {
...
func TestIsISO3166Alpha3(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsISO3166Alpha3(test.param)
		if actual != test.expected {
...
func TestIsISO693Alpha2(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsISO693Alpha2(test.param)
		if actual != test.expected {
...
func TestIsISO693Alpha3b(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsISO693Alpha3b(test.param)
		if actual != test.expected {
...
func TestIsIP(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsIPv4(test.param)
		if actual != test.expected {
	...
	for _, test := range tests {
		actual := utils.IsIPv6(test.param)
		if actual != test.expected {
...
func TestIsPort(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsPort(test.param)
		if actual != test.expected {
...
func TestIsDNSName(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsDNSName(test.param)
		if actual != test.expected {
...
func TestIsHost(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsHost(test.param)
		if actual != test.expected {
...
func TestIsDialString(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsDialString(test.param)
		if actual != test.expected {
...
func TestFilePath(t *testing.T) {
	...
	var tests = []struct {
		...
		{"c:\\" + strings.Repeat("a", 32767), true, utils.Win}, //See http://msdn.microsoft.com/en-us/library/aa365247(VS.85).aspx#maxpath
		{"c:\\" + strings.Repeat("a", 32768), false, utils.Win},
		{"c:\\path\\file (x86)\bar", true, utils.Win},
		{"c:\\path\\file", true, utils.Win},
		{"c:\\path\\file:exe", false, utils.Unknown},
		{"C:\\", true, utils.Win},
		{"c:\\path\\file\\", true, utils.Win},
		{"c:/path/file/", false, utils.Unknown},
		{"/path/file/", true, utils.Unix},
		{"/path/file:SAMPLE/", true, utils.Unix},
		{"/path/file:/.txt", true, utils.Unix},
		{"/path", true, utils.Unix},
		{"/path/__bc/file.txt", true, utils.Unix},
		{"/path/a--ac/file.txt", true, utils.Unix},
		{"/_path/file.txt", true, utils.Unix},
		{"/path/__bc/file.txt", true, utils.Unix},
		{"/path/a--ac/file.txt", true, utils.Unix},
		{"/__path/--file.txt", true, utils.Unix},
		{"/path/a bc", true, utils.Unix},
	}
	for _, test := range tests {
		actual, osType := utils.IsFilePath(test.param)
...
func TestIsLatitude(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsLatitude(test.param)
		if actual != test.expected {
...
func TestIsLongitude(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsLongitude(test.param)
		if actual != test.expected {
...
func TestIsMongoID(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsMongoID(test.param)
		if actual != test.expected {
...
func TestIsSemver(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsSemver(test.param)
		if actual != test.expected {
...
func TestIsTime(t *testing.T) {
	...
	var tests = []struct {
		...
		{"2016-12-31T11:00:00.05+01:00", time.RFC3339, true},
		{"2016-12-31T11:00:00", utils.RF3339WithoutZone, true},
		{"2016-12-31T11:00:00Z", utils.RF3339WithoutZone, false},
		{"2016-12-31T11:00:00+01:00", utils.RF3339WithoutZone, false},
		{"2016-12-31T11:00:00-01:00", utils.RF3339WithoutZone, false},
		{"2016-12-31T11:00:00.05Z", utils.RF3339WithoutZone, false},
		{"2016-12-31T11:00:00.05-01:00", utils.RF3339WithoutZone, false},
		{"2016-12-31T11:00:00.05+01:00", utils.RF3339WithoutZone, false},
	}
	for _, test := range tests {
		actual := utils.IsTime(test.param, test.format)
		if actual != test.expected {
...
func TestIsRFC3339(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsRFC3339(test.param)
		if actual != test.expected {
...
func TestIsISO4217(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsISO4217(test.param)
		if actual != test.expected {
...
func TestByteLength(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.ByteLength(test.value, test.min, test.max)
		if actual != test.expected {
...
func TestRuneLength(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.RuneLength(test.value, test.min, test.max)
		if actual != test.expected {
...
func TestStringLength(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.StringLength(test.value, test.min, test.max)
		if actual != test.expected {
...
func TestIsIn(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsIn(test.value, test.params...)
		if actual != test.expected {
...
func TestValidateMissingValidationDeclarationStruct(t *testing.T) {
	...
	utils.SetFieldsRequiredByDefault(true)
	for _, test := range tests {
		actual, err := utils.ValidateStruct(test.param)
		if actual != test.expected {
	...
	utils.SetFieldsRequiredByDefault(false)
}
...
func structToMaps(in interface{}) (map[string]interface{}, map[string]interface{}, error) {
	...
	for i := 0; i < v.NumField(); i++ {
		...
		if v.Field(i).Kind() == reflect.Struct {
			...
			tags[f.Name] = f.Tag.Get(utils.TagName)
		}
	}
	return out, tags, nil
}
...
func TestFieldRequiredByDefault(t *testing.T) {
	...
	for _, test := range tests {
		...
		if err != nil {
			...
			actual, err := utils.ValidateMap(mapParams, mapValidator)
			if actual != test.expected {
...
func TestInvalidValidator(t *testing.T) {
	...
	if valid, err := utils.ValidateStruct(&invalidStruct); valid || err == nil ||
	...
	if err != nil {
		...
		if valid, err := utils.ValidateMap(mapParams, mapValidator); valid || err == nil ||
			err.Error() != `Field: The following validator is invalid or can't be applied to the field: "someInvalidValidator"` {
...
func TestCustomValidator(t *testing.T) {
	...
	if valid, err := utils.ValidateStruct(&ValidStruct{Field: 1}); !valid || err != nil {
	...
	if valid, err := utils.ValidateStruct(&InvalidStruct{Field: 1}); valid || err == nil || err.Error() != "Value: 1 Custom validator error: customFalseValidator" {
		fmt.Println(err)
	...
	if mapParams, mapValidator, err := structToMaps(&InvalidStruct{Field: 1}); err != nil {
		...
		if valid, err := utils.ValidateMap(mapParams, mapValidator); valid || err == nil || err.Error() != "Value: 1 Custom validator error: customFalseValidator" {
	...
	if valid, err := utils.ValidateStruct(&mixedStruct); valid || err == nil || err.Error() != "Field: non zero value required" {
	...
	if mapParams, mapValidator, err := structToMaps(&mixedStruct); err != nil {
		...
		if valid, err := utils.ValidateMap(mapParams, mapValidator); valid || err == nil || err.Error() != "Field: non zero value required" {
	...
	if valid, err := utils.ValidateStruct(&mixedStruct); !valid || err != nil {
...
func TestStructWithCustomByteArray(t *testing.T) {
	...
	utils.CustomTypeTagMap.Set("customByteArrayValidator", func(i interface{}, o interface{}) bool {
		switch v := o.(type) {
	...
	utils.CustomTypeTagMap.Set("customMinLengthValidator", func(i interface{}, o interface{}) bool {
		switch v := o.(type) {
		case StructWithCustomByteArray:
...
func TestEmptyStringPtr(t *testing.T) {
	...
	utils.SetNilPtrAllowedByRequired(true)
	for _, test := range tests {
		actual, err := utils.ValidateStruct(test.param)
	...
	utils.SetNilPtrAllowedByRequired(false)
}
...
func TestNestedStruct(t *testing.T) {
	...
	for key, test := range tests {
		...
		if err != nil {
			...
			if err != nil {
				if err.Error() != test.expectedErr {
					t.Errorf("(key = %v) Got Error on ValidateMap(%q, %q) of %q. Expected: %s Actual: %s",
						key, mapParams, mapValidator, test.param, test.expectedErr, err)
				}
			} else if test.expectedErr != "" {
				t.Errorf("Expected error on ValidateMap(%q, %q) of %q.", mapParams, mapValidator, test.param)
			}
...
func TestValidateStruct(t *testing.T) {
	...
	utils.TagMap["d_k"] = func(str string) bool {
		return str == "d_k"
	}
	result, err := utils.ValidateStruct(PrivateStruct{"d_k", 0, []int{1, 2}, []string{"hi", "super"}, [2]Address{{"Street", "123456"},
...
func TestErrorByField(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.ErrorByField(err, test.param)
		if actual != test.expected {
...
func TestErrorsByField(t *testing.T) {
	...
	_, err = utils.ValidateStruct(message)
	errs = utils.ErrorsByField(err)
	if len(errs) != 2 {
		t.Errorf("There should only be 2 errors but got %v", len(errs))
	}
	...
	err = utils.Error{Name: "CustomField", Err: fmt.Errorf("An error occurred"), Validator: "hello", Path: []string{}}
	errs = utils.ErrorsByField(err)
	...
	utils.CustomTypeTagMap.Set("falseValidation", func(i interface{}, o interface{}) bool {
		return false
	})
...
func TestValidateStructPointers(t *testing.T) {
	...
	_, err := utils.ValidateStruct(user)
...
func TestValidateMapPointers(t *testing.T) {
	...
	if err != nil {
		...
		_, err = utils.ValidateMap(mapParams, mapValidator)
	}
...
func ExampleValidateStruct() {
	...
	utils.TagMap["duck"] = func(str string) bool {
		return str == "duck"
	}

	result, err := utils.ValidateStruct(post)
	if err != nil {
...
func TestValidateStructParamValidatorInt(t *testing.T) {
	...
	_, err := utils.ValidateStruct(test1Ok)
	if err != nil {
		t.Errorf("Test failed: %s", err)
	}

	_, err = utils.ValidateStruct(test1NotOk)
	if err == nil {
	...
	_, err = utils.ValidateStruct(test2Ok1)
	if err != nil {
		t.Errorf("Test failed: %s", err)
	}

	_, err = utils.ValidateStruct(test2Ok2)
	if err != nil {
		t.Errorf("Test failed: %s", err)
	}

	_, err = utils.ValidateStruct(test2NotOk)
	if err == nil {
		t.Errorf("Test failed: nil")
	}
	...
	_, err = utils.ValidateStruct(test3Ok1)
	if err != nil {
		t.Errorf("Test failed: %s", err)
	}

	_, err = utils.ValidateStruct(test3Ok2)
	if err != nil {
		t.Errorf("Test failed: %s", err)
	}

	_, err = utils.ValidateStruct(test3NotOk)
	if err == nil {
		t.Errorf("Test failed: nil")
	}
}
...
func TestValidateStructUpperAndLowerCaseWithNumTypeCheck(t *testing.T) {
	...
	_, err := utils.ValidateStruct(structCapital)
	if err != nil {
		t.Errorf("Test failed: nil")
		fmt.Println(err)
	}
	...
	_, err = utils.ValidateStruct(structLower)
	if err != nil {
		t.Errorf("Test failed: nil")
		fmt.Println(err)
	}
...
func TestIsCIDR(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.IsCIDR(test.param)
		if actual != test.expected {
...
func TestOptionalCustomValidators(t *testing.T) {
	utils.CustomTypeTagMap.Set("f2", func(i interface{}, o interface{}) bool {
		return false
	})
	...
	ok, err := utils.ValidateStruct(val)
...
func TestValidatorIncludedInError(t *testing.T) {
	...
	ok, errors := utils.ValidateStruct(post)
	if ok {
		t.Errorf("expected validation to fail %v", ok)
	}

	for _, e := range errors.(utils.Errors) {
		casted := e.(utils.Error)
	...
	ok, errors = utils.ValidateStruct(message)
	if ok {
		t.Errorf("expected validation to fail, %v", ok)
	}
	...
	ok, errors = utils.ValidateStruct(&cs)
	if ok {
		t.Errorf("expected validation to fail, %v", ok)
	}

	validator := errors.(utils.Errors)[0].(utils.Error).Validator
	if validator != "length" {
...
-----END PUBLIC KEY-----`, 4096, false},
	...
	for i, test := range tests {
		actual := utils.IsRsaPublicKey(test.rsastr, test.keylen)
		if actual != test.expected {
...
func TestDoNotRepeatStructErrors(t *testing.T) {
	...
	ok, errors := utils.ValidateStruct(r)
	if ok {
		t.Errorf("expected validation to fail, %v", ok)
	}

	validator := errors.(utils.Errors)[0].(utils.Errors)[0].(utils.Error).Validator
	if validator != "matches" {
		t.Errorf("expected validator for Text to be matches, but was %s", validator)
	}

	if len(errors.(utils.Errors).Errors()) > 1 {
		t.Errorf("expected errors count to be 1, but was %d (%#v)", len(errors.(utils.Errors).Errors()), errors)
	}
}
...
func TestValidateMap(t *testing.T) {
	...
	for _, test := range tests {
		actual, err := utils.ValidateMap(test.params, test.validator)
		if actual != test.expected {
