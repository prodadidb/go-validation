...
func TestContains(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.Contains(test.param1, test.param2)
...
func TestMatches(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.Matches(test.param1, test.param2)
		if actual != test.expected {
...
func TestLeftTrim(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.LeftTrim(test.param1, test.param2)
		if actual != test.expected {
...
func TestRightTrim(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.RightTrim(test.param1, test.param2)
		if actual != test.expected {
...
func TestTrim(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.Trim(test.param1, test.param2)
		if actual != test.expected {
...
func TestWhiteList(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.WhiteList(test.param1, test.param2)
		if actual != test.expected {
...
func ExampleWhiteList() {
	...
	println(utils.WhiteList("a3a43a5a4a3a2a23a4a5a4a3a4", "a-z") == "aaaaaaaaaaaa")
}
...
func TestBlackList(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.BlackList(test.param1, test.param2)
		if actual != test.expected {
...
func TestStripLow(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.StripLow(test.param1, test.param2)
		if actual != test.expected {
...
func TestReplacePattern(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.ReplacePattern(test.param1, test.param2, test.param3)
		if actual != test.expected {
...
func ExampleReplacePattern() {
	...
	// - Sequence of digits.
	// with empty string.
	println(utils.ReplacePattern("http123123ftp://git534543hub.comio", "(ftp|io|[0-9]+)", "") == "http://github.com")
}
...
func TestEscape(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.Escape(test.param)
		if actual != test.expected {
...
func TestUnderscoreToCamelCase(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.UnderscoreToCamelCase(test.param)
		if actual != test.expected {
...
func TestCamelCaseToUnderscore(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.CamelCaseToUnderscore(test.param)
		if actual != test.expected {
...
func TestReverse(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.Reverse(test.param)
		if actual != test.expected {
...
func TestGetLines(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.GetLines(test.param)
...
func TestGetLine(t *testing.T) {
	...
	for _, test := range tests {
		actual, _ := utils.GetLine(test.param1, test.param2)
		if actual != test.expected {
...
func TestRemoveTags(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.RemoveTags(test.param)
		if actual != test.expected {
...
func TestSafeFileName(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.SafeFileName(test.param)
		if actual != test.expected {
...
func TestNormalizeEmail(t *testing.T) {
	...
	for _, test := range tests {
		actual, err := utils.NormalizeEmail(test.param)
		if actual != test.expected {
...
func TestTruncate(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.Truncate(test.param1, test.param2, test.param3)
		if actual != test.expected {
...
func TestPadLeft(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.PadLeft(test.param1, test.param2, test.param3)
		if actual != test.expected {
...
func TestPadRight(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.PadRight(test.param1, test.param2, test.param3)
		if actual != test.expected {
...
func TestPadBoth(t *testing.T) {
	...
	for _, test := range tests {
		actual := utils.PadBoth(test.param1, test.param2, test.param3)
		if actual != test.expected {
